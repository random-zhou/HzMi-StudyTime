...
HzMi赫兹矩阵创新实验室开源社区定位为由实验室同学自发组织的开源学习社区，为了让大家的学习机器人制作设计和搜集相关知识的难度大大降低而生

我们非常希望你们能够为 HzMi赫兹矩阵创新实验室 开源社区做出贡献，并且帮助我们把它做得比现在更好！

## 提交请求（PR）

作为贡献者，在你提交你的请求之前，以下是我们希望你遵循的规范：

1. 首先，在 [HzMi-StudyTime GitHub](https://github.com/random-zhou/HzMi-StudyTime/pulls) 中搜索与您想要提交相关的内容开放或关闭的 PR。我们想您也不希望重复现有的工作。

2. 然后 [HzMi-StudyTime Fork](https://github.com/random-zhou/HzMi-StudyTime/fork) [HzMi-StudyTime](https://github.com/random-zhou/HzMi-StudyTime) 仓库，并下载你的仓库到本地

   ```
   git clone 【你fork的仓库地址】
   ```

3. 添加HzMi-StudyTime原仓库，方便同步远程仓库最新的更新
...
8. 回到GitHub仓库页面，提交PR到`HzMi-StudyTime:main`
