...
/*
motor data,  0:chassis motor1 3510;1:chassis motor3 3510;2:chassis motor3 3510;3:chassis motor4 3510;
电机数据, 0:底盘电机1 3510电机,  1:底盘电机2 3510电机,2:底盘电机3 3510电机,3:底盘电机4 3510电机;
...
/**
  * @brief          send CAN packet of ID 0x700, it will set chassis motor 3510 to quick ID setting
  * @param[in]      none
  * @retval         none
  */
/**
  * @brief          发送ID为0x700的CAN包,它会设置3510电机进入快速设置ID
  * @param[in]      none
  * @retval         none
  */
